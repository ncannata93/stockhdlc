          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="font-medium text-orange-800">Problema de conexión detectado</p>
                  <p className="text-sm text-orange-600">Use la herramienta de diagnóstico para solucionarlo</p>
                </div>
              </div>
              <Button variant="outline" size="sm" asChild>
                <Link href="/empleados/diagnostico">Diagnóstico</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
